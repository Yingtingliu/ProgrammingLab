package SE_Lab2_seit_1;

public class Main1 {

	public static void main(String[] args)	{
		Person	w1 = new Worker("aaa", new dob(1, 2, 1991)); 
		Person	w2 = new Worker("bbb", new dob(3, 4, 1993));
		Person	w3 = new Worker("ccc", new dob(5, 6, 1995));
	
		Person	b1 = new Boss("ddd", new dob(7, 8, 1997)); 
		Person	b2 = new Boss("eee", new dob(9,10, 1999)); 
