...
public class MinMaxAveView1 extends JFrame {
	public JButton clearButton, quitButton;
	public JTextField enterField;
	private JTextField minField, maxField, aveField;
	private MinMaxAveController1 controllerObject;
	private MinMaxAveModel modelObject;

	public MinMaxAveView1(MinMaxAveModel model, MinMaxAveController1 controller) {
