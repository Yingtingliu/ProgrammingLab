package Prog.week9_swingContinuedLecture2;
...
public class MinMaxAveView2 extends JFrame {
	public JButton clearButton, quitButton;
	public JTextField enterField;
	private JTextField minField, maxField, aveField;
	private MinMaxAveController2 controllerObject;
	private MinMaxAveModel modelObject;

	public MinMaxAveView2(MinMaxAveModel model, MinMaxAveController2 controller) {
