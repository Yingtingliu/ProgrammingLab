...
public class PlayerOld {
	...
	//constructor
	public PlayerOld(Board board, String name) {
		this.board = board;
		this.name = name;		
	}
	
	public boolean takeTurn(Board board,PlayerOld player, Square[][] gameboard,BattleShip[] battleShipArray) {
		//print the board
	...
	public void gameOver(PlayerOld player) {		
